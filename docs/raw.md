...
**Day 2:**  
Loki starts drafting. Uses all the research. Keywords from Vision, quotes from Fury, UX notes from Shuri.

**Day 3:**  
Loki posts first draft. Status moves to Review. I review and give feedback. Loki revises. Done.
...
```bash
clawdbot cronadd --name "agent-heartbeat" --cron "*/15 * * * *" \
  --session "isolated" \
